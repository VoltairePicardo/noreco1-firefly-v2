...
public class StockAdjustmentDocumentDto {
    ...
    public StockAdjustmentDocumentDto() {
    }

    public StockAdjustmentDocumentDto(Integer id, String localCode, BigDecimal netAmount, String particulars, Date voucherDate, String preparedBy, Integer slentityAccountNo, String slentityName, Date invoiceDate, Integer paymentTerm, Date dueDate, Integer transactionId, BigDecimal quantity, String extensionUrl) {
        this.id = id;
