...
@RestController
@RequestMapping("/api/other-account-receivable")
public class OtherAccountReceivableController {

    @Autowired
    MessageSource messageSource;

    @Autowired
    @Qualifier("otherAccountReceivableServiceImpl")
    OtherAccountReceivableService service;
    ...
    @PostMapping("/create")
    public PostResponse create(@RequestBody OtherAccountReceivable entity) {
        BindingResult bindingResult = new BeanPropertyBindingResult(entity, "otherAccountReceivable");
    ...
    @PostMapping("/update")
    public PostResponse update(@RequestBody OtherAccountReceivable entity) {
        BindingResult bindingResult = new BeanPropertyBindingResult(entity, "otherAccountReceivable");
    ...
    public void exportToPdf(@PathVariable Integer id,
        ...
        String template = GlobalConstant.JASPER_BASE_PATH + "/vouchers/OtherAccountReceivable.jrxml";
