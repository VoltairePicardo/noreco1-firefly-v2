...
@RestController
@RequestMapping(value = "/api/purchase-request")
public class PurchaseRequestController {
    ...
    public PostResponse create(@RequestBody PurchaseRequest purchaseRequest) {
        ...
        return purchaseRequestService.processCreate(purchaseRequest, bindingResult, messageSource);
    }

    @PostMapping("/update")
    public PostResponse update(@RequestBody PurchaseRequest purchaseRequest) {
        BindingResult bindingResult = new BeanPropertyBindingResult(purchaseRequest, "purchaseRequest");
        return purchaseRequestService.processUpdate(purchaseRequest, bindingResult, messageSource);
    }
    ...
    public Page<Map<String, Object>> purchaseRequestListForStockWithdrawal(@PathVariable Integer invLocId,
                                                                    @RequestParam(value = "q", required = false) String query,
                                                                    Pageable pageable) {

        return purchaseRequestService.purchaseRequestListForStockWithdrawal(invLocId, query, pageable);
    }
