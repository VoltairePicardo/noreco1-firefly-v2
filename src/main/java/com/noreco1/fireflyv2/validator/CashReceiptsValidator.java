...
public class CashReceiptsValidator implements Validator {
    ...
    public void validate(Object o, Errors errors) {
        ...
        CommonValidator.validateBackdating(errors, monthlyCycleRepo, cr.getVoucherDate());
        CommonValidator.validateJournal(errors, cr.getGeneralLedgerLines(), cr.getSubLedgerLines(), this.allocationFactorRepo);
    }
