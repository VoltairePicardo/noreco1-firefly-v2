...
public class JvValidator implements Validator {
    ...
    public void validate(Object o, Errors errors) {
        ...
        CommonValidator.validateBackdating(errors, monthlyCycleRepo, jv.getVoucherDate());
        CommonValidator.validateJournal(errors, jv.getGeneralLedgerLines(), jv.getSubLedgerLines(), this.allocationFactorRepo);
