...
@Component({
    selector: 'app-budget-item-classification-main',
    imports: [...COMMON_ALL_PAGE_IMPORTS, ...COMMON_MAIN_PAGE_IMPORTS],
    providers: [...SHARED_PROVIDERS],
    templateUrl: './budget-item-classification-main.component.html'
})
export class BudgetItemClassificationMainComponent {
