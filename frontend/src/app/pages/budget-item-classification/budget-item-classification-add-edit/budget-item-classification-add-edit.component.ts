...
@Component({
    selector: 'app-budget-item-classification-add-edit',
    imports: [...COMMON_ALL_PAGE_IMPORTS, ...COMMON_ADD_EDIT_PAGE_IMPORTS, LaddaModule],
    templateUrl: './budget-item-classification-add-edit.component.html'
})
export class BudgetItemClassificationAddEditComponent {
