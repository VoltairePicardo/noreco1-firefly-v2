...
@Component({
    selector: 'app-special-equipment-assignment-detail',
    imports: [...COMMON_ALL_PAGE_IMPORTS, SharedModule, FormsModule, RouterLink],
    templateUrl: './special-equipment-assignment-detail.component.html'
})
export class SpecialEquipmentAssignmentDetailComponent {
    module = 'Special Equipment Assignment'; subModule = 'Details'; menuLink = 'special-equipment-assignment';
