...
@Component({
    selector: 'app-special-equipment-assignment-add-edit',
    ...
    templateUrl: './special-equipment-assignment-add-edit.component.html'
})
export class SpecialEquipmentAssignmentAddEditComponent {
    module = 'Special Equipment Assignment'; subModule = 'Create'; menuLink = 'special-equipment-assignment';
