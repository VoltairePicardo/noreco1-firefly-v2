...
@Component({
    selector: 'app-cash-receipts-detail',
    ...
    templateUrl: './cash-receipts-detail.component.html'
})
export class CashReceiptsDetailComponent {
    ...
    print(): void { this.service.print(this.id); }
}
