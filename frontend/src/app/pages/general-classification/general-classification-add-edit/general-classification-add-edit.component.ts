...
@Component({
    selector: 'app-general-classification-add-edit',
    imports: [...COMMON_ALL_PAGE_IMPORTS, ...COMMON_ADD_EDIT_PAGE_IMPORTS, LaddaModule],
    templateUrl: './general-classification-add-edit.component.html'
})
export class GeneralClassificationAddEditComponent {
