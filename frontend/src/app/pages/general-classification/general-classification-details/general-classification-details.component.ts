...
@Component({
    selector: 'app-general-classification-details',
    imports: [...COMMON_ALL_PAGE_IMPORTS, SharedModule],
    templateUrl: './general-classification-details.component.html'
})
export class GeneralClassificationDetailsComponent {
