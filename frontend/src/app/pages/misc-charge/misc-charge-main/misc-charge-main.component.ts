...
@Component({
    selector: 'app-misc-charge-main',
    imports: [...COMMON_ALL_PAGE_IMPORTS, ...COMMON_MAIN_PAGE_IMPORTS],
    providers: [...SHARED_PROVIDERS],
    templateUrl: './misc-charge-main.component.html'
})
export class MiscChargeMainComponent {
    module    = 'Miscellaneous Charge';
    subModule = '';
    menuLink  = 'misc-charge';

    miscCharges   = signal<any[]>([]);
    ...
    load(page = 0): void {
        ...
        this.service.list(this.searchText, page).subscribe({
            next: (data) => {
                this.miscCharges.set(data.content);
