...
export class IemopBillingService {
    ...
    list(page = 0, size = 20, q = ''): Observable<any> {
        ...
        return this.http.get(`${BASE_API}/iemop-billing/list`, { params });
    }

    getData(id: number): Observable<any> {
        return this.http.get(`${BASE_API}/iemop-billing/${id}`);
    }
    ...
    upload(file: File, date: string, referenceNumber: string): Observable<any> {
        ...
        return this.http.post(`${BASE_API}/iemop-billing/upload`, fd);
    }
}
