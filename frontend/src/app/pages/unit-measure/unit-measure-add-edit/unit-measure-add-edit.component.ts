...
@Component({
    selector: 'app-unit-measure-add-edit',
    imports: [...COMMON_ALL_PAGE_IMPORTS, ...COMMON_ADD_EDIT_PAGE_IMPORTS, LaddaModule],
    templateUrl: './unit-measure-add-edit.component.html'
})
export class UnitMeasureAddEditComponent {
    module    = 'Unit of Measure';
    subModule = 'Create';
    menuLink  = 'unit-measure';
    id: any   = 0;
    editMode  = false;
    submit    = false;
    formSubmit = false;
    ...
    private service      = inject(UnitMeasureService);
