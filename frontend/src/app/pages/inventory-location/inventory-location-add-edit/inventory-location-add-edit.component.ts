...
@Component({
    selector: 'app-inventory-location-add-edit',
    imports: [...COMMON_ALL_PAGE_IMPORTS, ...COMMON_ADD_EDIT_PAGE_IMPORTS, LaddaModule],
    templateUrl: './inventory-location-add-edit.component.html'
})
export class InventoryLocationAddEditComponent {
    ...
    initForm(data?: any): void {
        ...
        this.validationForm = this.fb.group({
            ...
            isSubsidy:   [data?.isSubsidy   ?? false],
    ...
    validSubmit(): void {
        ...
        const { accountId, ...rest } = this.form.value;
        const frm = { id: this.editMode ? this.id : null, ...rest, account: { id: accountId } };
