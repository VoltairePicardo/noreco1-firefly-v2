...
export class ReceiveSummaryComponent implements OnInit {
    ...
    search(): void {
        ...
        this.service.getReceiveSummary(this.fromDate, this.toDate, this.locationId, this.statusId).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(
            `/reports/export/receive-summary/${this.fromDate}/${this.toDate}/${this.statusId}`,
