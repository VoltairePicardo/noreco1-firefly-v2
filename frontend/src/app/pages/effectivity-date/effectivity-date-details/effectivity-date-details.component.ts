...
@Component({
    selector: 'app-effectivity-date-details',
    imports: [...COMMON_ALL_PAGE_IMPORTS, SharedModule],
    templateUrl: './effectivity-date-details.component.html'
})
export class EffectivityDateDetailsComponent {
    ...
    delete(): void {
        Swal.fire({
            ...
            html: `<p>Are you sure you want to delete <strong>${this.data.description || this.data.start}</strong>?</p>`,
            icon: 'warning',
