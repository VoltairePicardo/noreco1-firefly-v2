...
@Component({
    selector: 'app-strategic-initiative-add-edit',
    imports: [...COMMON_ALL_PAGE_IMPORTS, ...COMMON_ADD_EDIT_PAGE_IMPORTS, LaddaModule],
    templateUrl: './strategic-initiative-add-edit.component.html'
})
export class StrategicInitiativeAddEditComponent {
    ...
    ngOnInit(): void {
        this.service.listDepartments().subscribe({ next: d => this.departments.set(d), error: () => {} });
    ...
    initForm(data?: any): void {
        this.validationForm = this.fb.group({
            ...
            departmentId:  [data?.department?.id  || null, Validators.required],
        });
    }
