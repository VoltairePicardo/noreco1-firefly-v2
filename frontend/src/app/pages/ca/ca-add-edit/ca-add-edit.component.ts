...
export class CaAddEditComponent {
    ...
    initForm(data?: any): void {
        ...
        this.validationForm = this.fb.group({
            ...
            budgetLineItemDetailId:    [data?.budgetLineItemDetail?.id || null, Validators.required],
            recommendedByAccountNo:    [data?.recommendedBy?.accountNo    || null, Validators.required],
    ...
    validSubmit(): void {
        ...
        const payload: any = {
            ...
            employee:         null,
            office:               v.officeId              ? (this.offices().find(o => o.id === v.officeId) || { id: v.officeId }) : null,
