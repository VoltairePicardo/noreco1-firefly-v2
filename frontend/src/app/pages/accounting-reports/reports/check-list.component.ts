...
export class CheckListComponent {
    ...
    search(): void {
        ...
        this.rows.set([]);
        this.service.getCheckList(this.fromDate, this.toDate).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(`/reports/export/check-list`, { type, from: this.fromDate, to: this.toDate });
    }
}
