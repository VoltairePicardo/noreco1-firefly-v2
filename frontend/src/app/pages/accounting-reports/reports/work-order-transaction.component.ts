...
@Component({
    selector: 'app-work-order-transaction',
    ...
    templateUrl: './work-order-transaction.component.html'
})
export class WorkOrderTransactionComponent {
    module   = 'Work Order Transaction';
    ...
    search(): void {
        ...
        this.rows.set([]);
        this.service.getWorkOrderTransaction(this.fromDate, this.toDate).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(`/reports/export/work-order-transaction/${this.fromDate}/${this.toDate}`, { type });
    }
}
