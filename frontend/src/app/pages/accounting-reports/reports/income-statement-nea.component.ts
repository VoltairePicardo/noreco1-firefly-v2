...
@Component({
    selector: 'app-income-statement-nea',
    ...
    templateUrl: './income-statement-nea.component.html'
})
export class IncomeStatementNeaComponent {
    module   = 'Statement of Operations (NEA)';
    ...
    search(): void {
        ...
        this.rows.set([]);
        this.service.getIncomeStatementNeaData(this.fromDate, this.toDate, this.fsType).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(`/reports/export/income-statement-nea/${this.fromDate}/${this.toDate}/${this.fsType}`, { type });
    }
}
