...
export class CashRegisterComponent {
    ...
    search(): void {
        ...
        this.service.getCashRegister(this.fromDate, this.toDate, this.selectedStatusId).subscribe({
            next: (data) => { this.rows.set(data || []); this.isLoading.set(false); },
            error: () => { this.isLoading.set(false); }
        });
        this.service.getCashRegisterRecap(this.fromDate, this.toDate, this.selectedStatusId).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(`/reports/export/cash-register/${this.fromDate}/${this.toDate}/${this.selectedStatusId}`, { type });
    }
}
