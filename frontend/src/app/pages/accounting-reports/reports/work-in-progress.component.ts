...
export class WorkInProgressComponent {
    ...
    search(): void {
        ...
        this.rows.set([]);
        this.service.getWorkInProgress(this.fromDate, this.toDate, this.statusDescription).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(`/reports/export/work-in-progress/${this.fromDate}/${this.toDate}/${this.statusDescription}`, { type });
    }
}
