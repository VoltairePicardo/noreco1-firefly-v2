...
export class IncomeStatementComponent {
    ...
    search(): void {
        ...
        this.rows.set([]);
        this.service.getIncomeStatementData(this.fromDate, this.toDate).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(`/reports/export/income-statement/${this.fromDate}/${this.toDate}`, { type });
    }
}
