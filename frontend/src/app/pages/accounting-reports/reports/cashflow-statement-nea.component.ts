...
@Component({
    selector: 'app-cashflow-statement-nea',
    ...
    templateUrl: './cashflow-statement-nea.component.html'
})
export class CashflowStatementNeaComponent {
    module   = 'Cash Flow Statement (NEA)';
    ...
    search(): void {
        ...
        this.rows.set([]);
        this.service.getCashFlowStatement(this.fromDate, this.toDate).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(
            `/reports/export/cashflow-statement/${this.fromDate}/${this.toDate}/${this.checkedBy.accountNo}/${this.notedBy.accountNo}`,
            { type }
        );
    }
}
