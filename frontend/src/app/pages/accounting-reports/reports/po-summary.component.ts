...
export class PoSummaryComponent {
    ...
    search(): void {
        ...
        this.service.getPoSummary(this.fromDate, this.toDate, this.selectedStatusId).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(`/reports/export/po-summary/${this.fromDate}/${this.toDate}/${this.selectedStatusId}`, { type });
    }
}
