...
@Component({
    ...
    templateUrl: './joa-summary.component.html'
})
export class JoaSummaryComponent {
    module   = 'JOA Summary';
    ...
    search(): void {
        ...
        this.service.getJoaSummary(this.fromDate, this.toDate, this.selectedStatusId).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(`/reports/export/joa-summary/${this.fromDate}/${this.toDate}/${this.selectedStatusId}`, { type });
    }
}
