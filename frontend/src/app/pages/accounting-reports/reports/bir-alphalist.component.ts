...
@Component({
    selector: 'app-bir-alphalist',
    imports: [...COMMON_ALL_PAGE_IMPORTS, ...COMMON_MAIN_PAGE_IMPORTS],
    providers: [...SHARED_PROVIDERS],
    templateUrl: './bir-alphalist.component.html'
})
export class BirAlphalistComponent {
    module   = 'BIR Alphalist';
    ...
    search(): void {
        ...
        this.rows.set([]);
        this.service.getBirAlphalistData(year, month).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(`/reports/export/bir-alphalist/${year}/${month}`, { type });
    }
}
