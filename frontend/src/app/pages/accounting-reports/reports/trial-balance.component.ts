...
export class TrialBalanceComponent {
    ...
    search(): void {
        ...
        this.rows.set([]);
        this.service.getOpenMonthsForTrialBalance('', this.asOfDate).subscribe({
            next: (data) => this.openMonths.set(data ?? [])
        });
        this.service.getTrialBalanceData(this.asOfDate).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(`/reports/export/trial-balance/${this.asOfDate}`, { type });
    }
}
