...
@Component({
    ...
    templateUrl: './canvass-summary.component.html'
})
export class CanvassSummaryComponent {
    module   = 'Canvass Summary';
    ...
    search(): void {
        ...
        this.service.getCanvassSummary(this.fromDate, this.toDate, this.selectedStatusId).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(`/reports/export/canvass-summary/${this.fromDate}/${this.toDate}/${this.selectedStatusId}`, { type });
    }
}
