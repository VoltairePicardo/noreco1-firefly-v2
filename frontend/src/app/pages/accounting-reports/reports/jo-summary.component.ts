...
@Component({
    ...
    templateUrl: './jo-summary.component.html'
})
export class JoSummaryComponent {
    module   = 'JO Summary';
    ...
    search(): void {
        ...
        this.service.getJoSummary(this.fromDate, this.toDate, this.selectedStatusId).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(`/reports/export/jo-summary/${this.fromDate}/${this.toDate}/${this.selectedStatusId}`, { type });
    }
}
