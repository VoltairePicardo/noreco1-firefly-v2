...
export class PrSummaryComponent {
    ...
    search(): void {
        ...
        this.service.getPrSummary(this.fromDate, this.toDate, this.selectedStatusId).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(`/reports/export/pr-summary/${this.fromDate}/${this.toDate}/${this.selectedStatusId}`, { type });
    }
}
