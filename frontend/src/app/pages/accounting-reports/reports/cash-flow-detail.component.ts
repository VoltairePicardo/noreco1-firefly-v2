...
export class CashFlowDetailComponent {
    ...
    totalAmount = computed(() =>
        this.rows()
            .filter(row => row.account.indexOf('Sub total') === -1)
    ...
    search(): void {
        ...
        this.service.getCashFlowDetail(this.fromDate, this.toDate).subscribe({
    ...
    export(type: 'pdf' | 'xls'): void {
        ...
        this.downloadSvc.print(`/reports/export/cash-flow-detail`, { type, from: this.fromDate, to: this.toDate });
    }
}
