...
@Component({
    selector: 'app-project-acceptance-report-detail',
    ...
    templateUrl: './project-acceptance-report-detail.component.html'
})
export class ProjectAcceptanceReportDetailComponent {
