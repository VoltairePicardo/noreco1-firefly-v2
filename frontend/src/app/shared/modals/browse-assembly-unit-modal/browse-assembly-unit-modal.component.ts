...
import { AssemblyUnitService } from '@/app/pages/assembly-unit/assembly-unit.service';

@Component({
    selector: 'app-browse-assembly-unit-modal',
    ...
    templateUrl: './browse-assembly-unit-modal.component.html'
})
export class BrowseAssemblyUnitModalComponent implements OnInit {
