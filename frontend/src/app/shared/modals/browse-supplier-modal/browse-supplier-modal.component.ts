...
import { SupplierService } from '@/app/pages/supplier/supplier.service';

@Component({
    selector: 'app-browse-supplier-modal',
    ...
    templateUrl: './browse-supplier-modal.component.html'
})
export class BrowseSupplierModalComponent implements OnInit {
